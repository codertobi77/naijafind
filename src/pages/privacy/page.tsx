            ...
            <div className="prose max-w-none">
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-gray-700 mb-4">
                    {t('privacy.intro_title') === '1. Introduction' ? 
                      'Suji ("we", "our" or "ours") is committed to protecting and respecting your privacy. This privacy policy explains how we collect, use, store and protect your personal information when you use our platform.' : 
                      'Suji ("nous", "notre" ou "nos") s\'engage à protéger et respecter votre vie privée. Cette politique de confidentialité explique comment nous collectons, utilisons, stockons et protégeons vos informations personnelles lorsque vous utilisez notre plateforme.'}
                  </p>
                  <p className="text-gray-700">
                    {t('privacy.intro_title') === '1. Introduction' ? 
                      'By using Suji, you accept the practices described in this privacy policy.' : 
                      'En utilisant Suji, vous acceptez les pratiques décrites dans cette politique de confidentialité.'}
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-gray-700">
                    {t('privacy.your_rights_title') === '6. Your rights' ? 
                      'To exercise these rights, contact us at privacy@Suji.com' : 
                      'Pour exercer ces droits, contactez-nous à privacy@Suji.com'}
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg">
                    <ul className="space-y-2 text-gray-700">
                      <li><strong>{t('privacy.contact_email')}</strong> privacy@Suji.com</li>
