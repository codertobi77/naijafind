      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-16">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-5">
            ...
            {/* Multimedia Upload: product description video, image, or document (Word/PDF) */}
            <FileUpload
              label={t('purchase_request.attachment', 'Vidéo, image ou document descriptif du produit (optionnel)')}
              value={attachment}
              onChange={(url) => setAttachment(url || null)}
              description={t('purchase_request.attachment_desc', 'Joignez une vidéo descriptive du produit (MP4, WebM, MOV), une image (JPG, PNG) ou un document (PDF, Word)')}
              maxFileSizeMB={20}
