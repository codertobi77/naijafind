export const admin = {
  ...
  "admin.premium_suppliers": "Premium Suppliers",
  "admin.premium_suppliers_description": "Manage premium suppliers displayed on the homepage.",
  "admin.all_premium_suppliers": "All Premium Suppliers",
  "admin.premium_status": "Premium Status",
  "admin.set_premium": "Set Premium",
  "admin.remove_premium": "Remove Premium",
  "admin.premium": "Premium",
  "admin.not_premium": "Not Premium",
  "admin.featured": "Featured",
  "admin.not_featured": "Not Featured",
  "admin.no_premium_suppliers": "No premium suppliers",
  ...
  "admin.total_suppliers": "Total Suppliers",
  "admin.status": "Status",
  ...
  "admin.search_icons": "Search icons...",
  "admin.image_url_placeholder": "https://example.com/image.jpg",
  "admin.notification_title": "Notification title",
  ...
  "admin.type_system": "System",
  "admin.type_order": "Order",
  "admin.type_review": "Review",
  "admin.type_message": "Message",
  "admin.type_verification": "Verification",
  "admin.type_approval": "Approval",
  "admin.all_users": "All users",
  "admin.all_suppliers": "All suppliers",
  "admin.filter_by_category": "Filter by category",
  "admin.notifications_history": "Notifications history",
  "admin.date": "Date",
  "admin.sent_by": "Sent by",
  "admin.sent_to": "Sent to",
  "admin.preview": "Preview",
  "admin.sent": "Sent",
  "admin.no_notifications": "No notifications",
  "admin.user": "User",
  "admin.recipient_type": "Recipient type",
  "admin.select_type": "Select type",
  "admin.fill_all_fields": "Please fill all fields",
  "admin.notification_sent": "Notification sent successfully",
  "admin.error_sending_notification": "Error sending notification",
  "admin.error_fetching_notifications": "Error fetching notifications",
